    ...
    <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
        <div class="container flex flex-wrap justify-between items-center mx-auto">
            <a href="{{ route('login.usuario') }}" class="flex">
                ...
                <span
                    class="self-center text-lg font-semibold whitespace-nowrap dark:text-white">{{ ucfirst($usuario->rol) }}</span>
            </a>
                        ...
                        @if ($usuario->rol == 'administrador')
                            <li>
                                <a href="{{ route('registro.create') }}"
                                    class="block py-2 px-4 text-sm text-gray-700 hover:bg-green-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Crear
                                    usuario</a>
                            </li>
                        @endif
                        <li>
